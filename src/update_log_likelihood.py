...
if __name__ == '__main__':
    graphs_path = r"C:\Projects\Heuristics for combinatorial optimisation\Heuristics-for-combinatorial-optimisation\data\graphs\SBM(100, 2, a)weak.json"  # Use raw string for Windows path
