...
if __name__ == "__main__":
    file_path = r"C:\Projects\Heuristics for combinatorial optimisation\Heuristics-for-combinatorial-optimisation\data\graphs\SBM(40, 4, c).json"
    ...
    graph_g, log_likelihood_data_g, final_w_g = optimise_sbm2(graph, num_groups, algo_func="reluctant")
