...
if __name__ == "__main__":
    file_path = r"C:\Projects\Heuristics for combinatorial optimisation\Heuristics-for-combinatorial-optimisation\data\graphs\SBM(2000, 2, c).json"
    ...
    # graph_g, log_likelihood_data_g, final_w_g = optimise_sbm4(graph, num_groups, group_mode, algo_func=fr)
    ...
    with open(os.path.join(graphs_path, f"{graph_name}2_results.json"), 'w') as f:
        json.dump(results, f, indent = 2)

    print(f"Saved results to {graphs_path}/{graph_name}2_results.json")  
