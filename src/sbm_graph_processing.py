...
if __name__ == "__main__":
    file_path = r"C:\Projects\Heuristics for combinatorial optimisation\Heuristics-for-combinatorial-optimisation\data\graphs\SBM(10000, 2, a).json"
    ...
    # greedy_state = SBMState(graph, num_groups, group_mode)
    # graph_g, log_likelihood_data_g, final_w_g = greedy_state.optimise(algo_func="reluctant")

    # graph_g, log_likelihood_data_g, final_w_g = optimise_sbm4(graph, num_groups, group_mode, algo_func=fg)
    # graph_r, log_likelihood_data_r, final_w_r = optimise_sbm4(graph, num_groups, group_mode, algo_func=fr)
