...
from algorithms import optimise_sbm, optimise_sbm2, optimise_sbm3, optimise_sbm4, optimise_sbm5, GreedyState
...
if __name__ == "__main__":
    ...
    greedy_state = GreedyState(graph, num_groups, group_mode)
    graph_g, log_likelihood_data_g, final_w_g = greedy_state.optimise(algo_func=fg)
