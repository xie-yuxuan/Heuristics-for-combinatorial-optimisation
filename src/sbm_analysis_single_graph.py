...
from visualisation import plot_cost_data, plot_final_costs, plot_cost_diff_histogram, sbm_plot_cost_data

if __name__ == '__main__':

    file_path = r"C:\Projects\Heuristics for combinatorial optimisation\Heuristics-for-combinatorial-optimisation\results\SBM(20, 2, b)_results.json"
